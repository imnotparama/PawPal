...
export function DogPanel() {
  return (
    <div className="relative w-full h-full flex items-center justify-end">
      ...
      {/* Text on the right side — particles morph in the background */}
      <div className="relative max-w-[500px] pr-10 lg:pr-20 z-10">
        <span className="text-plum-voltage" style={{ fontSize: 12, fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase" }}>
          For every species. Every breed. Every quirk.
        </span>

        <h2 className="mt-6 text-bone" style={{ fontSize: "clamp(36px, 5vw, 68px)", lineHeight: 0.92, letterSpacing: "-0.04em", fontWeight: 200 }}>
          A vet in
          <br />
          your pocket,
          <br />
        ...
        <p className="mt-8 text-ash" style={{ fontSize: 15, lineHeight: 1.55, letterSpacing: "0.015em" }}>
