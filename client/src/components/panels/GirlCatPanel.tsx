...
export function GirlCatPanel() {
  return (
    <div className="relative w-full h-full flex items-center">
      ...
      {/* Text on the left — particles morph in the background */}
      <div className="relative mx-auto max-w-[1300px] px-6 lg:px-10 w-full z-10">
        <div className="max-w-[460px]">
          ...
          <h2 className="mt-5 text-bone" style={{ fontSize: "clamp(36px, 5vw, 64px)", lineHeight: 0.92, letterSpacing: "-0.04em", fontWeight: 200 }}>
            Hold them
            <br />
            closer, with
            <br />
          ...
          <p className="mt-6 text-ash max-w-[400px]" style={{ fontSize: 15, lineHeight: 1.55 }}>
        ...
        <div className="absolute bottom-8 left-6 right-6 lg:left-10 lg:right-10 grid grid-cols-3 gap-4">
